<?php 
    ...
    if (isset($_GET['id'])) {
        ...
        $id_logado = $_SESSION['idusuario'];
        $idferramenta = mysqli_real_escape_string($con, $_GET['id'])?? '';
        $ferramenta = mysqli_real_escape_string($con, $_GET['ferramenta'])?? '';
       ...
       <main class="ability">
        <div class="ability__container">
           <h2 class="ability__title">
            ...
            <form class="ability__form" action="acoes/cria-ferramenta.php" id="form" method="POST">
                <div class="ability__content">
                    <label for="ferramenta">ferramentas
                    </label>
                    <input
                    type="text"
                    name="ferramenta"
                ...
                <input type="hidden" name="idferramenta" id="idferramenta" 
                value="<?= ($idferramenta)?? '' ?>">
        ...
        <?php require_once 'acoes/consulta-ferramentas-do-usuario.php';?>
        <?php 
            if ($resultado->num_rows > 0) {
                ...
                while ($dados = mysqli_fetch_assoc($resultado)) {
                    ...
                    echo "<li class='ability__item' name='ferramenta'>
                                <a href='?id=$idferramenta&ferramenta=$ferramenta' class='ability__link'>$ferramenta</a>
                        </li>";
                }
                echo "</ul>";
            }
